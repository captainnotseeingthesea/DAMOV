...
l1iPrefix = "l1i-"
l1dPrefix = "l1d-"
l2prefetcherPrefix = "l2prefetcher-"
l2Prefix = "l2-"
if(numCores == 1):
    l3Prefix = "l3-"
else:
...
for i in range(numCores):
    l1i = l1iPrefix+str(i)
    l1d = l1dPrefix+str(i)
    l2prefetcher = l2prefetcherPrefix+str(i)
    l2 = l2Prefix+str(i)
    l3 = l3Prefix+str(i)
    mem = "mem"
    ...
    print("Connecting "+l1d+" to "+l2prefetcher)
    f.write(l1d+" "+l2prefetcher+" "+"0 0\n")

    print("Connecting " +l2prefetcher+" to "+l2)
    f.write(l2prefetcher+" "+l2+" "+"0 0\n")
